      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [
              'omg audit [scan]',
              'Scan installed packages for vulnerabilities; v0.1.223 requires a daemon, while the newer checkout can scan directly',
            ],
            [
              'omg audit sbom',
              'Write a CycloneDX system-package inventory. In v0.1.223, the required vulnerability match succeeds on Arch only; the newer checkout supports Arch, Debian, Ubuntu, and Fedora. -o/--output selects the file',
            ],
            ...
            [
              ...
              'Verify a supported artifact signature against the required --certificate-identity value',
            ],
            [
              'omg audit licenses',
            ...
            [
              'omg audit export',
              'Export SOC 2 evidence; --framework, --period, and --output. Other framework names are accepted but unimplemented',
            ],
            [
              'omg audit eol',
